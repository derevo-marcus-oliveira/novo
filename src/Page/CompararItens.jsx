                ...
                return (
                    <div className="row gy-5 text-justify" key={id}>
                        ...
                        <div className="col-5 tabela">
                            <div className="p-3">
                                {
                                    (itens[0].especificacoes.filter(item => item.especificacao.match(criarPadrao(a.especificacao))).length > 0) ?
                                        itens[0].especificacoes.filter(item => item.especificacao.match(criarPadrao(a.especificacao)))[0].especificacao_descricao : ""
                                }
                            </div>
                        </div>
                        <div className="col-5 tabela">
                            <div className="p-3">
                                {
                                    (itens[1].especificacoes.filter(item => item.especificacao.match(criarPadrao(a.especificacao))).length > 0) ?
                                        itens[1].especificacoes.filter(item => item.especificacao.match(criarPadrao(a.especificacao)))[0].especificacao_descricao : ""
                                }
                            </div>
                        </div>
                    </div>
